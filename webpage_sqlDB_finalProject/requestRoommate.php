...
<div class="content text-center mt-5">
    <h3>What student wants roommates?:</h3>


    <form action="requestRoommate.php" method="post">
    ...
    if (isset($_POST['submit'])) 
    {
        ...
        $command = 'java -cp .:mysql-connector-java-5.1.40-bin.jar requestRoommate ' . $studentID;
