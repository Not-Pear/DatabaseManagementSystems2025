...
<div class="content text-center mt-5">
    ...
    <h3>Enter information about the assignment you want!:</h3>
    ...
    if (isset($_POST['submit'])) 
    {
        ...
        $roomNum = escapeshellarg($_POST[roomNum]);


        $command = 'java -cp .:mysql-connector-java-5.1.40-bin.jar addAssignment ' . $studentID . ' ' . $buildingID . ' ' .  $roomNum;
